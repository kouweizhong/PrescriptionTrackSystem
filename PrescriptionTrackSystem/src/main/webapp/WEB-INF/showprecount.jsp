				...
				<!-- BEGIN EXAMPLE TABLE PORTLET-->
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-globe"></i>用户处方数量</div>
								<div class="actions">
									<div class="btn-group">
										...
										<div id="sample_2_column_toggler" class="dropdown-menu hold-on-click dropdown-checkboxes pull-right">
											<label><input type="checkbox" checked data-column="0">用户名称</label>
											<label><input type="checkbox" checked data-column="1">承保单号</label>
								...
								<table class="table table-striped table-bordered table-hover table-full-width" id="sample_2">
									<thead>
										<tr>
											...
											<th>电话号码</th>
											<th>承保公司</th>
											<th class="hidden-480">处方数量</th>
											<th>操作</th>
										</tr>
									</thead>
									<tbody>
									<c:forEach var="p" items="${infos }">
									<tr>
										<td>${p[0] }</td>
										<td>${p[1] }</td>
										<td>${p[2] }</td>
										<td>${p[3] }</td>
										<td>${p[4] }</td>
										<td><a href="findPre/${p[5] }">处方信息</a></td>
										</tr>
									</c:forEach>
									</tbody>
								</table>
