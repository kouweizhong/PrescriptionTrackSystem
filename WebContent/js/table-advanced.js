var TableAdvanced = function () {
    ...
    var initTable1 = function() {
        ...
        function fnFormatDetails ( oTable, nTr )
        {
            ...
            var sOut = '<table>';
            sOut += '<tr><td>出生日期:</td><td>'+aData[2]+'</td></tr>';
            sOut += '<tr><td>电话号码:</td><td>'+aData[3]+'</td></tr>';
            sOut += '<tr><td>承保公司:</td><td>'+aData[4]+'</td></tr>';
            sOut += '<tr><td>保单号:</td><td>'+aData[5]+'</td></tr>';
            sOut += '</table>';
            return sOut;
        }
        ...
        jQuery('#sample_1_wrapper .dataTables_length select').addClass("m-wrap small"); // modify table 放 dropdown
